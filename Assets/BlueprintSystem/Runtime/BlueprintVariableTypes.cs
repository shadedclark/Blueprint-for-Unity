...
namespace BlueprintSystem
{
    ...
    public static class BlueprintVariableTypeRegistry
    {
        ...
        private static readonly Dictionary<string, Type> BuiltinTypesById = new Dictionary<string, Type>(StringComparer.Ordinal)
        {
            ...
            { "VehicleRoadLaneSortMode", typeof(VehicleRoadLaneSortMode) },
            { "VehicleRoadRouteTargetSelectionMode", typeof(VehicleRoadRouteTargetSelectionMode) },
        ...
        private static readonly Dictionary<Type, string> BuiltinIdsByType = new Dictionary<Type, string>
        {
            ...
            { typeof(VehicleRoadLaneSortMode), "VehicleRoadLaneSortMode" },
            { typeof(VehicleRoadRouteTargetSelectionMode), "VehicleRoadRouteTargetSelectionMode" },
